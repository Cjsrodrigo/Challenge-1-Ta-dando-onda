...
var choice2 = choose(options: 2)

if choice2 == "1" {
    print("Helena passa por sua prova desafiadora e vence o campeonato, lembrando da sua árdua jornada e as memórias com seu pai.")
} else if choice2 == "2" {
    print("Helena passa dificuldades durante sua prova, a parafina estava vencida, fazendo com que a mesma tome um caldo, caia e se desclassifique do torneio.")
} else{
