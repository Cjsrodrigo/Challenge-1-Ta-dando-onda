...
func introduction(){
    ...
    print("Qual o nome da mãe da \(mainName!)?")
    momName = readLine()

    print("Qual o nome do pai da \(mainName!)?")
    dadName = readLine()
    clearScreen()
    print("\(mainName!), uma menina nascida e criada em Ubatuba, de família simples e sem luxos. Cresceu com os seus pais, \(dadName!) e \(momName!), e desde que se entende por gente o seu passatempo favorito sempre foi surfar com seu pai, que era apaixonado pelo esporte e passou a paixão para a filha.")
    ...
    print("** \(mainName!), opta por: **\n 1: Voltar a dormir \n 2: Falar com o pai e o desejar boas ondas")
    choice = choose(2)
    ...
    if choice == "1"{
        ...
        print("Ela abraça a mãe e as duas choram juntas, abaladíssimas com o ocorrido.\n")
    }
    keepGoing()
}
